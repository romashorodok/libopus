...
pub const OPUS_SET_OSCE_BWE_REQUEST: libc::c_int = 4054;
pub const OPUS_GET_OSCE_BWE_REQUEST: libc::c_int = 4055;
...
unsafe extern {
  pub fn opus_encoder_create(
    Fs: opus_int32, channels: libc::c_int, application: libc::c_int,
    error: *mut libc::c_int,
  ) -> *mut OpusEncoder;
}
unsafe extern {
  pub fn opus_encoder_init(
    st: *mut OpusEncoder, Fs: opus_int32, channels: libc::c_int,
    application: libc::c_int,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_encode(
    st: *mut OpusEncoder, pcm: *const opus_int16, frame_size: libc::c_int,
    data: *mut libc::c_uchar, max_data_bytes: opus_int32,
  ) -> opus_int32;
}
unsafe extern {
  pub fn opus_encode24(
    st: *mut OpusEncoder, pcm: *const opus_int32, frame_size: libc::c_int,
    data: *mut libc::c_uchar, max_data_bytes: opus_int32,
  ) -> opus_int32;
}
unsafe extern {
  pub fn opus_encode_float(
    st: *mut OpusEncoder, pcm: *const f32, frame_size: libc::c_int,
    data: *mut libc::c_uchar, max_data_bytes: opus_int32,
  ) -> opus_int32;
}
unsafe extern {
...
unsafe extern {
  pub fn opus_encoder_ctl(
    st: *mut OpusEncoder, request: libc::c_int, ...
  ) -> libc::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
unsafe extern {
  pub fn opus_decoder_create(
    Fs: opus_int32, channels: libc::c_int, error: *mut libc::c_int,
  ) -> *mut OpusDecoder;
}
unsafe extern {
  pub fn opus_decoder_init(
    st: *mut OpusDecoder, Fs: opus_int32, channels: libc::c_int,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_decode(
    st: *mut OpusDecoder, data: *const libc::c_uchar, len: opus_int32,
    pcm: *mut opus_int16, frame_size: libc::c_int, decode_fec: libc::c_int,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_decode24(
    st: *mut OpusDecoder, data: *const libc::c_uchar, len: opus_int32,
    pcm: *mut opus_int32, frame_size: libc::c_int, decode_fec: libc::c_int,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_decode_float(
    st: *mut OpusDecoder, data: *const libc::c_uchar, len: opus_int32,
    pcm: *mut f32, frame_size: libc::c_int, decode_fec: libc::c_int,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_decoder_ctl(
    st: *mut OpusDecoder, request: libc::c_int, ...
  ) -> libc::c_int;
}
unsafe extern {
...
unsafe extern {
  pub fn opus_dred_decoder_create(
    error: *mut libc::c_int,
  ) -> *mut OpusDREDDecoder;
}
unsafe extern {
...
unsafe extern {
  pub fn opus_dred_decoder_ctl(
    dred_dec: *mut OpusDREDDecoder, request: libc::c_int, ...
  ) -> libc::c_int;
}
unsafe extern {
...
unsafe extern {
  pub fn opus_dred_parse(
    dred_dec: *mut OpusDREDDecoder, dred: *mut OpusDRED,
    data: *const libc::c_uchar, len: opus_int32, max_dred_samples: opus_int32,
    sampling_rate: opus_int32, dred_end: *mut libc::c_int,
    defer_processing: libc::c_int,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_dred_process(
    dred_dec: *mut OpusDREDDecoder, src: *const OpusDRED, dst: *mut OpusDRED,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_decoder_dred_decode(
    st: *mut OpusDecoder, dred: *const OpusDRED, dred_offset: opus_int32,
    pcm: *mut opus_int16, frame_size: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_decoder_dred_decode24(
    st: *mut OpusDecoder, dred: *const OpusDRED, dred_offset: opus_int32,
    pcm: *mut opus_int32, frame_size: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_decoder_dred_decode_float(
    st: *mut OpusDecoder, dred: *const OpusDRED, dred_offset: opus_int32,
    pcm: *mut f32, frame_size: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_packet_parse(
    data: *const libc::c_uchar, len: opus_int32, out_toc: *mut libc::c_uchar,
    frames: *mut *const libc::c_uchar, size: *mut opus_int16,
...
unsafe extern {
  pub fn opus_packet_get_samples_per_frame(
    data: *const libc::c_uchar, Fs: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
...
unsafe extern {
  pub fn opus_packet_get_nb_frames(
    packet: *const libc::c_uchar, len: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_packet_get_nb_samples(
    packet: *const libc::c_uchar, len: opus_int32, Fs: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
...
unsafe extern {
  pub fn opus_decoder_get_nb_samples(
    dec: *const OpusDecoder, packet: *const libc::c_uchar, len: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_pcm_soft_clip(
    pcm: *mut f32, frame_size: libc::c_int, channels: libc::c_int,
...
unsafe extern {
  pub fn opus_repacketizer_cat(
    rp: *mut OpusRepacketizer, data: *const libc::c_uchar, len: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_repacketizer_out_range(
    rp: *mut OpusRepacketizer, begin: libc::c_int, end: libc::c_int,
    data: *mut libc::c_uchar, maxlen: opus_int32,
  ) -> opus_int32;
}
unsafe extern {
  pub fn opus_repacketizer_get_nb_frames(
    rp: *mut OpusRepacketizer,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_repacketizer_out(
    rp: *mut OpusRepacketizer, data: *mut libc::c_uchar, maxlen: opus_int32,
  ) -> opus_int32;
}
unsafe extern {
  pub fn opus_packet_pad(
    data: *mut libc::c_uchar, len: opus_int32, new_len: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_packet_unpad(
    data: *mut libc::c_uchar, len: opus_int32,
  ) -> opus_int32;
}
unsafe extern {
...
unsafe extern {
  pub fn opus_multistream_packet_unpad(
    data: *mut libc::c_uchar, len: opus_int32, nb_streams: libc::c_int,
  ) -> opus_int32;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
unsafe extern {
  pub fn opus_multistream_encoder_get_size(
    streams: libc::c_int, coupled_streams: libc::c_int,
  ) -> opus_int32;
}
unsafe extern {
  pub fn opus_multistream_surround_encoder_get_size(
    channels: libc::c_int, mapping_family: libc::c_int,
  ) -> opus_int32;
}
unsafe extern {
  pub fn opus_multistream_encoder_create(
    Fs: opus_int32, channels: libc::c_int, streams: libc::c_int,
    coupled_streams: libc::c_int, mapping: *const libc::c_uchar,
    application: libc::c_int, error: *mut libc::c_int,
  ) -> *mut OpusMSEncoder;
}
unsafe extern {
  pub fn opus_multistream_surround_encoder_create(
    Fs: opus_int32, channels: libc::c_int, mapping_family: libc::c_int,
    streams: *mut libc::c_int, coupled_streams: *mut libc::c_int,
    mapping: *mut libc::c_uchar, application: libc::c_int,
    error: *mut libc::c_int,
  ) -> *mut OpusMSEncoder;
}
unsafe extern {
  pub fn opus_multistream_encoder_init(
    st: *mut OpusMSEncoder, Fs: opus_int32, channels: libc::c_int,
    streams: libc::c_int, coupled_streams: libc::c_int,
    mapping: *const libc::c_uchar, application: libc::c_int,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_multistream_surround_encoder_init(
    st: *mut OpusMSEncoder, Fs: opus_int32, channels: libc::c_int,
    mapping_family: libc::c_int, streams: *mut libc::c_int,
    coupled_streams: *mut libc::c_int, mapping: *mut libc::c_uchar,
    application: libc::c_int,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_multistream_encode(
    st: *mut OpusMSEncoder, pcm: *const opus_int16, frame_size: libc::c_int,
    data: *mut libc::c_uchar, max_data_bytes: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_multistream_encode24(
    st: *mut OpusMSEncoder, pcm: *const opus_int32, frame_size: libc::c_int,
    data: *mut libc::c_uchar, max_data_bytes: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
  pub fn opus_multistream_encode_float(
    st: *mut OpusMSEncoder, pcm: *const f32, frame_size: libc::c_int,
    data: *mut libc::c_uchar, max_data_bytes: opus_int32,
  ) -> libc::c_int;
}
unsafe extern {
...
unsafe extern {
  pub fn opus_multistream_encoder_ctl(
    st: *mut OpusMSEncoder, request: libc::c_int, ...
  ) -> libc::c_int;
}
unsafe extern {
...
unsafe extern {
  pub fn opus_multistream_decoder_init(
    st: *mut OpusMSDecoder, Fs: opus_int32, channels: libc::c_int,
    streams: libc::c_int, coupled_streams: libc::c_int,
...
unsafe extern {
  pub fn opus_multistream_decode(
    st: *mut OpusMSDecoder, data: *const libc::c_uchar, len: opus_int32,
    pcm: *mut opus_int16, frame_size: libc::c_int, decode_fec: libc::c_int,
  ) -> libc::c_int;
}
unsafe extern {
...
unsafe extern {
  pub fn opus_multistream_decoder_ctl(
    st: *mut OpusMSDecoder, request: libc::c_int, ...
  ) -> libc::c_int;
}
unsafe extern {
